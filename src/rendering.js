...
export default function link(scope, elem, attrs, ctrl) {
  var data, panel;
  elem = elem.find('.scatterplot-panel__chart');
  ...
  function addScatterChart() {
    ...
    plotCanvas.bind("plothover", function (event, pos, item) {
      ...
      body = '<div class="scatterplot-tooltip-small"><div class="scatterplot-tooltip-time">';
      body += '<div class="scatterplot-tooltip-value">' + item.series.label + ': ' + formatted;
      body += " (" + percent + "%)" + '</div>';
      body += "</div></div>";
