...
System.register(['app/plugins/sdk', 'lodash', 'app/core/utils/kbn', 'app/core/time_series', './rendering', './legend'], function (_export, _context) {
  ...
  var MetricsPanelCtrl, _, kbn, TimeSeries, rendering, legend, _createClass, ScatterPlotCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('ScatterPlotCtrl', ScatterPlotCtrl = function (_MetricsPanelCtrl) {
        ...
        function ScatterPlotCtrl($scope, $injector, $rootScope) {
...
//# sourceMappingURL=scatterplot_ctrl.js.map